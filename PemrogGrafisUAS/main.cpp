...
void display(void)
{
    ...
    glPushMatrix();
    glRotatef((GLfloat)z,1.0,1.0,1.0); //for rotate sun
    ...
    glRotatef((GLfloat)m,0.0,1.0,0.0); //for rotate mercury
    ...
    glRotatef((GLfloat)v,0.0,1.0,0.0);//for rotate venus
    glColor3f(7.5,9.5,1.0);
    glutSolidSphere(0.2,20,8);   /*draw smaller plant venus*/
    glPopMatrix();

    glPushMatrix();
    glRotatef((GLfloat)E,0.0,1.0,0.0);//for earth rotation to sun
    glTranslatef(3.5,0.0,0.0);
    glRotatef((GLfloat)e,0.0,1.0,0.0);//for rotate earth
    glColor3f(0.1,6.5,2.0);
    glutSolidSphere(0.2,20,8);    /*draw smaller plant earth*/
    glRotatef((GLfloat)X,0.0,1.0,0.0);//for rotate moon
    ...
    glRotatef((GLfloat)r,0.0,1.0,0.0);//for rotate mars
    ...
    glRotatef((GLfloat)j,0.0,1.0,0.0);//for rotate jupiter
...
void idleFunc(void)
{
    ...
    e =(e+1);//for automatic rotation earth like looping
    E =(E+1);
    display();
}
